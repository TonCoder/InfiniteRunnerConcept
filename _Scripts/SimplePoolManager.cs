...
public class SimplePoolManager : MonoBehaviour {
    ...
    // Get Actions
    //****************************
    public GameObject GetPoolItem (string nameOfPool) {
        if (!DoesPoolItemExist (nameOfPool)) {
            return null;
        }
    ...
    bool DoesPoolItemExist (string nameOfPool) {
